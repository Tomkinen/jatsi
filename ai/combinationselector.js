module.exports = {
    ...
    for (let keep of keepAll) {
  	...
  	const keepAny=['fourOfAKind','twoPairs','threeOfAKind','onePair','chance'];
  	...
  	const keepFinal=['smallStraight','largeStraight','fullHouse','fourOfAKind','twoPairs','threeOfAKind','onePair','yatzy',
